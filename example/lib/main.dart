        ...
        child: Center(
          child: Column(
            children: [
              ...
              buildPaymentCard(color: Colors.cyan, cardType: CardNetwork.americanExpress, '2345678909123456'),
              ...
              const SizedBox(height: 10),
              buildPaymentCard(color: Colors.redAccent, cardType: CardNetwork.mastercard, '4234567890123456'),
              const SizedBox(height: 10),
              buildPaymentCard(color: Colors.teal, cardType: CardNetwork.visa, '5234567890123456'),
              const SizedBox(height: 10),
              buildPaymentCard(color: Colors.pink, cardType: CardNetwork.verve, '6234567890123456'),
              const SizedBox(height: 10),
              buildPaymentCard(bg: 'packages/payment_card/assets/images/bg/1.png', cardType: CardNetwork.visa, '3534567890123456'),
              const SizedBox(height: 10),
              buildPaymentCard(bg: 'packages/payment_card/assets/images/bg/2.png', cardType: CardNetwork.mastercard, '5234567890123456'),
              const SizedBox(height: 10),
              buildPaymentCard(bg: 'packages/payment_card/assets/images/bg/3.png', cardType: CardNetwork.visa, '6234567890123456'),
              const SizedBox(height: 10),
            ],
          ),
        ),
